let conversionObject = {
    ...
    functions: {
        converter: function (context, from, to, subject) {
            ...
            for (let i in conversionObject.special) {
                if (i === context) {
                    specialTest = i;
                }
            }
            ...
            let cResult = conversionObject.master[context][to] / conversionObject.master[context][from] * subject;
            return (cResult % 1 === 0 ? cResult.toFixed() : cResult.toFixed(3));
        }
    }
};